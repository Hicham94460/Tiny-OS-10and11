...
3. Run tiny11 creator.bat as administrator. If you have a version .525 or 25300, use the aptly-named script (also as administrator).
...
7. When the image is completed, you will see it in the folder where the script was extracted, with the name tiny11.iso or tiny10.iso if you need this with Windows 10.
